...
from ..models import BigramPattern, PoissonUnigramPattern, UniformUnigramPattern
...
def main():
    ...
    if args.charlm:
        ...
        char_lm = Uniform(len(target_corpus.stem_vocabulary))
    ...
    if args.model == 0:
        ...
        pattern_base = PoissonUnigramPattern(n_morphemes, alpha_prior, 1.0, 1.0, pvoc)
    elif args.model == 10:
